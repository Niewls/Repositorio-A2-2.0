...
public class RendimentoEscolarFakeDB extends BaseGenericaFakeDB <RendimentoEscolar>{ //800 - 900
    ...
    protected void CarregarDados(){
       CarregarTrabalhos(); 
       this.lista.add(new RendimentoEscolar(801, listaAlunos.get(0), listaTurmas.get(0), 8.5, 7, notaAluno1));
       this.lista.add(new RendimentoEscolar(802, listaAlunos.get(0), listaTurmas.get(0), 4, 8, notaAluno2));
       this.lista.add(new RendimentoEscolar(803, listaAlunos.get(0), listaTurmas.get(0), 8.5, 7, notaAluno1));
       this.lista.add(new RendimentoEscolar(804, listaAlunos.get(0), listaTurmas.get(0), 8.5, 7, notaAluno1));
    }
    ...
    public void CarregarTrabalhos(){
        ...
        this.notaAluno12D4.add(listaTrabalhos.get(190)); // PAROU AQUI Rony
